...
export function initMastersData() {
    ...
    if (tattooGrid) renderMasters('tattoo-masters-grid', 'tattoo');
    if (barberGrid) renderMasters('barber-masters-grid', 'barber');
    
    window.addEventListener('serviceChanged', (e) => {
        if (e.detail.service === 'tattoo') {
            renderMasters('tattoo-masters-grid', 'tattoo');
        } else if (e.detail.service === 'barber') {
